    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Add
            <small>New Messages on the Communicaton Board</small>
          </h1>
        </section>
          ...
          <div class="row">
            ...
            <?php
                        ...
                        <form role="form" method="post" action="../opera/addsome.php" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-lg-6 col-md-6 text-center">
                              <label>Edit your message here</label>
                              <textarea rows="5" class="form-control ckeditor" placeholder="Enter your messages here..." name="content"></textarea>
                            </div>
                            </div>
                    </div>
                    <div class="box-footer text-center"><p><input type="submit" name="msg" class="btn btn-success" value="Post your messages"> | <input class="btn btn-default" type="reset" value="Reset"></p></div>
                        </form>
                </div>
        ...
        <section class="content-header">
          <h1>
            All
            <small>Communicatons Added</small>
          </h1>
        </section>
        ...
        <section class="content">
          ...
          <div class="box-body">
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <?php
                include("../connect.php");
                $sqli="SELECT * FROM gahunda ORDER BY ID DESC";
                    ...
                    <div class="modal fade" id="myModal'.$row['ID'].'" tabindex="-1" role="dialog" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-sm">
                        <div style="background-color:white" class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel">'.ucfirst($row['Day']).'</h4>
                        </div>
                        ...
                        <div style="padding:5px" class="row text-center">
                          ...
                          <div class="col-md-12"><p>Do you really want to delete this?</p><p><a href="../opera/delete.php?delll='.$row['ID'].'" class="btn btn-success">Delete</a> | <button type="button" class="btn bg-orange" data-dismiss="modal">Cancel</button></p></div>
                        </div>
                        </div>
                      </div>
                    </div>';
