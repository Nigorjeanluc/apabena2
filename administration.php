	...
	<div class="container">
		<div style="text-align:justify" class="row">
			<div class="col-lg-4">
				...
				<img src="img/home/10.jpg" alt="" class="img-responsive pull-left" />
				<p>
                    APABENA headquarters.
                </p>
			</div>
			<div class="col-lg-8">
				...
				<p class="lead">
					<em>
                        The General Assembly which is the supreme organ of the organisation. 
                ...
                <ul>
					<li><p class="lead">Chairperson (Legal representative)</p></li>
					<li><p class="lead">Vice-Chairperson (Vice-Legal representative)</p></li>
					<li><p class="lead">Advisor</p></li>
					<li><p class="lead">Secretary</p></li>
					<li><p class="lead">Treasurer</p></li>
				</ul>
                <p class="lead">
					<em>
                ...
                <ul>
					...
					<li><p class="lead">Conflict resolution committee to handle any conflict that arises in the organisation among its members or among its organs.</p></li>
				</ul>
			</div>
		</div>
		<!-- divider -->
